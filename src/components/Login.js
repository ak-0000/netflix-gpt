        ...
        if(!isSignInForm){
            ...
            .then((userCredential) => {
                // Signed up 
                    ...
                    updateProfile(user, {
                        displayName: name.current.value, photoURL: "https://lh3.googleusercontent.com/-slZf3JVExHQ/AAAAAAAAAAI/AAAAAAAAAAA/ALKGfkm2v6G4TiE8Uqg4muWkuMm8XX4n8g/photo.jpg?sz=46",
                      }).then(() => {
                        // Profile updated!
                        // ...
